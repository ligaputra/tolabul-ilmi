...
<!-- TAG Form-->
<div data-role="page" id="kamus_edit">
<form method="post" action="edit.php">

<!-- TAG Header -->	
	<div data-role="header"><h1>Edit Kamus</h1></div>
...
<!-- TAG Main content -->	
	...
	<center><img src = "image/kamus.png"</a></center>
		...
		<input type="text" name="kata" value="<?php echo $row['kata'];?>">
		
		<label for="definisi">Definisi</label>
		<textarea name="definisi" id="definisi"><?php echo $row['definisi'];?></textarea>
...
<!-- Tombol Update-->		
	...
	?>
			<button class="ui-btn ui-corner-all ui-icon-carat-r ui-btn-icon-right" type="submit" name="update-kamus"><center>Ubah</center></button>
	<?php
	}
	?>
	</div>
