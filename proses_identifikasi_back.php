...
?>	
		...
		<div data-role="main" class="ui-content">
		<label for="kode node">Apakah gejala kerusakan sudah sesuai dengan instruksi sistem pakar?</label>
			<a href="a_star_test_4.php?id=<?php echo $kode;?>" class="ui-btn ui-btn-b btn-corner-all">YA</a>
			<a href="a_star_test_2.php?id=<?php echo $kode;?>" class="ui-btn ui-btn-b btn-corner-all">TIDAK</a>
		</div>
