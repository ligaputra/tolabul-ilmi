...
<!-------------- tag div untuk menu panel ----------->
	<div data-role="panel" id="MenuPanel" data-display="overlay"> 
		<a href="identifikasi_awal.php" class="ui-btn ui-corner-all ui-carat-r ui-btn-icon-right ui-mini" type="button">Identifikasi</a>
...
<!-------------- tag div untuk navigasi ----------->
	<div data-role="navbar" data-iconpos="bottom">
		<ul>
		    <li><a href="identifikasi_awal.php"><img src="image/01identifikasi128.png"><center><font size="5">Identifikasi Masalah</font></center></a></li>
		</ul>
		<ul>
		    <li><a href="kamus_list.php"><img src="image/kamus128.png"><center><font size="5">Kamus Pakar</font></center></a></li>
		</ul>
		<ul>
		    <li><a href="panel_admin.php"><img src="image/gear128.png"><center><font size="5">Panel Admin</font></center></a></li>
		</ul>
		<ul>
			<li><a href="#PopupProgram" data-rel="popup" data-position-to="window"><img src="image/android128.png"><center><font size="5">Tentang Program</font></center></a></li>
		</ul>
	</div>

<!-------------- Popup Tentang Program Pakar ----------->
		<div id="PopupProgram" data-role="popup" >
